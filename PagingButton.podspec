#
#  Be sure to run `pod spec lint PagingButton.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.screenshots  = "https://ws1.sinaimg.cn/large/cb81ffe8gy1fhstd8u6mpg20ag0lbdqf.gif"
  ...
  s.authors             = { "袁凤鸣" => "yfmingo@163.com" }
  # Or just: s.author    = "袁凤鸣"
  # s.authors            = { "袁凤鸣" => "yfmingo@163.com" }
